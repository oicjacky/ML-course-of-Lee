...
if __name__ == "__main__":
    ...
    print("Read image: using opencv(cv2) read images into np.array")
    ...
    print("分別將 training set、validation set、testing set 用 readfile 函式讀進來")
    workspace_dir = r'E:\Download\dataset\food-11'
    print("Reading data")
